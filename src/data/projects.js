export const projects = [
  {
    ...
    location: "Seattle, WA",
    year: "2026",
    summary: "A bright kitchen renovation with refined surfaces, storage, and fixture details.",
    description: "A kitchen portfolio set showing cabinetry, counters, fixture placement, and finish detail for a cleaner everyday cooking space.",
  ...
  },
  {
    ...
    location: "Bothell, WA",
    year: "2026",
    summary: "A connected living space with updated finishes and a calmer material palette.",
    description: "Interior renovation imagery showing how surface updates, trim, and finish choices can make connected rooms feel more intentional.",
  ...
  },
  {
    ...
    year: "2026",
    summary: "A quieter bathroom composition with improved surfaces and fixture placement.",
    description: "Bathroom renovation imagery focused on tile, fixture alignment, storage, and calm finish selections.",
  ...
  },
  {
    ...
    year: "2026",
    summary: "A compact bath refined with updated tile, fixtures, and clean storage details.",
    description: "A focused bathroom transformation showing how a smaller footprint can still feel polished and carefully resolved.",
    coverImage: "/images/projects/bathroom/bathroom8.jpeg",
    gallery: [
  ...
  },
  {
    ...
    description: "Kitchen island imagery showing cabinet installation, countertop coordination, hardware, and the details that make the island a useful center point.",
  ...
  },
  {
    ...
    year: "2026",
    summary: "A finish-focused refresh using updated surfaces and clean room details.",
    description: "A living-room focused interior refresh showing finish improvements, material choices, and cleaner visual flow.",
